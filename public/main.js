...
module.exports = "<app-base-page></app-base-page>\n<h3>Something about me,</h3>\n        <p>  My name in Shreyans Sharma, I am currently pursuing Software Engineering Technology at centennial college and will be graduating in this coming April. I’ve had the opportunity of representing my college in an artificial intelligence competition where I gained immense knowledge about machine learning and algorithms. I also had the privilege of working in the biggest tele communications company in Canada last summer where I gained knowledge about cyber security and how encrypted data is protected. I’ve always enjoyed interacting with new people and implementing different methodologies into all sorts of projects hence my interest in Business Analyst field.</p>\n        <p><b>Resume :- </b> <a href =\"/assets/images/Shreyans_Resume .pdf\">Download My Resume.</a></p>"
...
var AuthService = /** @class */ (function () {
    function AuthService(http, jwtService) {
        ...
        this.endpoint = 'https://comp308-w2019-lesson10b.herokuapp.com/api/';
...
var ContactListService = /** @class */ (function () {
    function ContactListService(http) {
        this.http = http;
        this.authToken = null;
        this.endpoint = 'https://comp308-w2019-lesson10b.herokuapp.com/api/contact-list/';
...
module.exports = __webpack_require__(/*! /Users/shreyanssharma/Desktop/Comp308_Assign -2_ShreyansSharma/client/src/main.ts */"./src/main.ts");
